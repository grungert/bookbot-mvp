...
export const MobileCTAScene: React.FC = () => {
      ...
      >
        ...
        <div style={{ textAlign: "center" }}>
          ...
          >
            ...
            >
              <MobileGradientText>{t.cta.line2}</MobileGradientText>
            </h1>
          </div>
        </div>
        ...
        {/* CTA Button with blue/purple glow */}
        <div
          style={{
            opacity: ctaOpacity,
          ...
          <div
            style={{
              ...
              boxShadow: `
                ...
                0 0 30px ${mobileColors.primary}60,
                0 0 30px ${mobileColors.secondary}50
              `,
