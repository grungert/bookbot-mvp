...
export const WhatsAppCTAScene: React.FC = () => {
      ...
      >
        ...
        <div style={{ textAlign: "center" }}>
          ...
          >
            ...
            >
              <WhatsAppGradientText>{t.cta.line2}</WhatsAppGradientText>
            </h1>
          </div>
        </div>
        ...
        {/* CTA Button with WhatsApp green glow */}
        <div
          style={{
            opacity: ctaOpacity,
          ...
          <div
            style={{
              ...
              boxShadow: `
                ...
                0 0 30px ${whatsappColors.primary}60,
                0 0 30px ${whatsappColors.secondary}50
              `,
