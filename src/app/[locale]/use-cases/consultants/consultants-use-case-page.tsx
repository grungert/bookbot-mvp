...
import { Briefcase, Zap, Globe2, Clock } from "lucide-react";
import {
  UseCaseLayout,
  UseCaseHero,
  PainPoints,
...
export function ConsultantsUseCasePage() {
  const t = useTranslations("useCases.consultants");
  ...
  const solutions = [
    { icon: Zap, title: t("solution1Title"), description: t("solution1Desc") },
    { icon: Globe2, title: t("solution2Title"), description: t("solution2Desc") },
